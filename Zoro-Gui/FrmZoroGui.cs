...
namespace Zoro_Gui
{
    public partial class FrmZoroGui : Form
    {
        ...
        {
            if (cbxLockMethod.Text == "Withdraw")
            {
        ...
        private void GetPerUnlockAmount(string method)
        {
            ...
            try
            {
                ...
                if (json.ContainsKey("result"))
                {
                    ...
                    rtbxLockReturnResult.Text = "Unlock Amount：" + value.ToString();
                }
            }
            catch (Exception ex)
            {
        ...
        private void GetUnlockInterval(string method)
        {
            ...
            try
            {
                ...
                if (json.ContainsKey("result"))
                {
                    ...
                    rtbxLockReturnResult.Text = "Unlock Interval：" + timeSpan.ToString();
                }
            }
            catch (Exception ex)
            {
        ...
        private void GetLockTimestamp(string method)
        {
            ...
            try
            {
                ...
                if (json.ContainsKey("result"))
                {
                    ...
                    DateTime targetDt = dtStart.Add(toNow).ToUniversalTime();

                    rtbxLockReturnResult.Text = "Current Lock Start Time：" + targetDt.ToString();
                }
            }
            catch (Exception ex)
            {
        ...
        private void QueryUnlockAmount(string method)
        {
            ...
            try
            {
                ...
                if (json.ContainsKey("result"))
                {
                    ...
                    rtbxLockReturnResult.Text = "Amount：" + value.ToString();
                }
            }
            catch (Exception ex)
            {
        ...
        private bool CheckLockParameter()
        {
            ...
            {
                MessageBox.Show("Lock Hash Is Null！", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return false;
            }

            if (string.IsNullOrEmpty(cbxLockMethod.Text))
            {
                MessageBox.Show("Operation Is Null！", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return false;
            }

            if (string.IsNullOrEmpty(tbxLockerAddress.Text))
            {
                MessageBox.Show("Lock Address Is Null！", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return false;
            }
            ...
            if (tbxWithdrawAddress.Visible)
            {
                ...
                {
                    MessageBox.Show("To Address Is Null！", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return false;
                }

                if (string.IsNullOrEmpty(accountFrmLock.wif))
                {
                    MessageBox.Show("Lock Address Wif Is Null！", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return false;
                }
            }
            return true;
